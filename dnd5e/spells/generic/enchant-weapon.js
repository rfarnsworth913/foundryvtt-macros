...
async function getItems ({ actorData, allowMagical = false, itemFilter = [] } = {}) {
    ...
    console.warn(actorData, actorData.items);
...
async function applyUpdates (uuid) {
    ...
    // Setup tracking flag ----------------------------------------------------
    DAE.setFlag(props.caster.actorData, "enhanceWeapon", {
...
async function removeUpdates ({ actorData } = {}) {
    ...
    // Get dependencies -------------------------------------------------------
    const flag = DAE.getFlag(actorData, "enhanceWeapon");
    ...
    DAE.unsetFlag(actorData, "enhanceWeapon");
